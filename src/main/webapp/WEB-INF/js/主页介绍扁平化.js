    ...
    var f= {
        ...
        fn: function(){
            ...
            $(t.f1).mouseover(function(){
                ...
                switch(index){
                    case 0:$(t.f4).css({"display":"block","transform":"rotateY(540deg)"});break;
                    case 1:$(t.f2).css({"display":"block","transform":"rotateY(540deg)"});break;
                    case 2:$(t.f3).css({"display":"block","transform":"rotateY(540deg)"});break;
                    case 3:$(t.f5).css({"display":"block","transform":"rotateY(540deg)"});break;
                }
            })
            $(t.f1).mouseout(function(){
                ...
                switch(index){
                    case 0:$(t.f4).css({"display":"none","transform":"rotateY(0deg)"});break;
                    case 1:$(t.f2).css({"display":"none","transform":"rotateY(0deg)"});break;
                    case 2:$(t.f3).css({"display":"none","transform":"rotateY(0deg)"});break;
                    case 3:$(t.f5).css({"display":"none","transform":"rotateY(0deg)"});break;
                }
            })
        }
