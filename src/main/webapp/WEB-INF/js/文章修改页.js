$(function () {
    ...
    locallist = {
        ...
        PageCount: 0,
        Local_list: 0,
        userid:JSON.parse(localStorage.getItem("editor_blog_id"))//要修改的博客id
    ...
    var j = {
        j1:function(){
            $.ajax({
                ...
                datatype:"json",
                async:false,
                url:locallist.Local_connection + "/blog/blog/"+locallist.userid+"/0",
                success:function(data,xhr){
                    console.log(data);
                    console.log(typeof(data));
                    console.log(locallist.userid)
                    data=JSON.parse(data);
                    console.log(data);
                    var dating =data.message;
                    dating_2=dating;
                    console.log(data.message)
                    dating=dating.blogBean;
                    
                    
                    dating=dating.blog;
                    dating_1=dating.userBean;
                    $("#x-editor_1").children("p").html(dating.title);
                    $("#x-editor").children("p").html(dating.article);
                    $("#x-editor_2").children("p").html(locallist.Local_connection+"/blog/img/"+dating.coverImg);
                    $(".x-Authors_name").children("p").html(dating_1.username);
                    $("#b_personal_InfName").children("h2").html(dating_1.username);
                    $(".x-circle_pra").children("p").html(dating.category);
                    $(".x-author_detailed_talked").children("p").html(dating.commentCount);
                    $(".x-author_detailed_eyes").children("p").html(dating.collectCount);
                    $(".x-author_detailed_loved").children("p").html(dating.upCount);
                    $(".x-The_portrait_of_the_author").css("background","url("+locallist.Local_connection+"/img/"+dating_1.face+") 0% 0% / 100%")
                    $("#w_myHead").css("background","url("+locallist.Local_connection+"/img/"+dating_1.face+") 0% 0% / 100%")
