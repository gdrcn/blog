$(function () {
  ...
  var a = {
    ...
    init: function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          Assignment(t.id, $(".b_dropdown_name b").eq(1));
    ...
    //页面切换跳转
    fn1: function () {
      $("#b_RDClogo , .b_RDChome").click(function () {
      ...
      $(".header_list").eq(1).click(function () {
        ...
        window.location.replace('http://www.onepi.top:8080/blog/html/文章个人列表页.html')
      })
      $(".header_list").eq(2).click(function () {
        window.location.replace('http://www.onepi.top:8080/blog/html/picWall.html')
      })
      $(".b_recent_sign").eq(0).click(function(){
        window.location.replace('http://www.onepi.top:8080/blog/html/picWallOthers.html')
      })
      $(".b_article_edit").click(function(){
        window.location.replace('http://www.onepi.top:8080/blog/html/文章编辑页.html')
      })
      $(".b_recent_sign").eq(1).click(function(){
        window.location.replace('http://www.onepi.top:8080/blog/html/文章个人列表页.html')
      })
      $(".b_current-user").click(function () {
        window.location.replace('http://www.onepi.top:8080/blog/html/mypage.html')
      })
      $(".b_RDCblogs").click(function(){
        window.location.replace('http://www.onepi.top:8080/blog/html/文章列表页.html')
      })
    ...
    get1: function () {
      $.ajax({
        ...
        success: function (data) {
          if (data.result == "success") {
            $(".b_fanss").not($(".b_fanss").eq(0)).remove();
            var t = data.message;
            console.log(t);
            var num3 = t.length;
    ...
    get2: function () {
      $.ajax({
        ...
        success: function (data) {
          $(".b_follows").not($(".b_follows").eq(0)).remove();
          if (data.result == "success") {
            var t = data.message;
            console.log(t);
            var num3 = t.length;
