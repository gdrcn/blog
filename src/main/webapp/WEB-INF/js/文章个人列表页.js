$(function () {
  locallist = {
    ...
    PageCount: 0,
    Local_list: 0,
    userid:localStorage.getItem("IDuser") //存放选中的blog的id__不顾哟在这里好像是没什么用的！！！
  ...
  b.Send_a_page_number_first(locallist.Local_user_Id, 0);
  ...
  c = {
    ...
    Paging_first: function (locallist_Local_list) {
      ...
      $(t.c3).click(function () { //首先是中间的按钮的点击事件
        ...
        select_up_and_down();
        b.Send_a_page_number_first(locallist.Local_user_Id, t.c6-1);
      })
      //点击上一个页面
      $(t.c1).click(function () {
        t.c6 = t.c6 - 1;
      ...
      $(t.d1).click(function () {
        ...
        switch (index) {
          ...
          case 1:
            ...
            break;
          case 2:
            b.Send_a_page_number_first("安卓", 0), locallist.Local_category_things = "安卓";
            c.Paging_first(locallist.Local_list);
            break;
          case 3:
  ...
  var e = {
    ...
    e1: function () {
      var t = this;
      $(t.e2).children("h2").click(function () {
    ...
    e3:function(){
      ...
      $(t.e4).click(function(){
        ...
        $.ajax({
          type: "post",
          dataType: "json",
          url: locallist.Local_connection + "/blog/deleteBlog" ,
          data:{
            blogId:blog_id
          },
          success:function(data,xhr){
      ...
      $(t.e5).click(function(){
        ...
        var index_thingking = locallist.Local_list.message;
        var index_thinking_thinking = index_thingking.blogBeans[index];
        console.log(locallist.Local_list);
        var blog_id_first = index_thinking_thinking.blog;
        var blog_id = blog_id_first.id;
        var obj = JSON.stringify(blog_id);
        localStorage.setItem("editor_blog_id", obj);
        console.log(index);
        console.log(blog_id);
        window.location.replace("http://www.onepi.top:8080/blog/html/%E6%96%87%E7%AB%A0%E4%BF%AE%E6%94%B9%E9%A1%B5.html");//跳转到修改页面
