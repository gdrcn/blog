$(function () {
  if(localStorage.getItem("IDuser")){
    ...
    script.src = "../js/b_mypage.js";
    document.body.appendChild(script);
    $("#b_personal_InfName p").removeClass("none");
    $("#w_myHead").removeClass("none");
  }
  else{
    $("#b_personal_InfName p").addClass("none");
    $("#w_myHead").addClass("none");
  }
  locallist = {
    Local_user_Id: localStorage.getItem("name"),
  ...
  b = {
    ...
    Send_a_page_number_first: function (category, page_numbers) {
      var t = this;
      ...
      $.ajax({
        ...
        async: false,
        url: locallist.Local_connection + "/blog/blogByCategory/" + category + "/" + page_numbers, //url
        error: function () {
          alert("gg");
        },
  ...
  b.Send_a_page_number_first("前端", 0);
  ...
  c = {
    ...
    Paging_first: function (locallist_Local_list) {
      ...
      $(t.c3).click(function () { //首先是中间的按钮的点击事件
        ...
        select_up_and_down();
        b.Send_a_page_number_first(locallist.Local_category_things, t.c6-1);
      })
      //点击上一个页面
      $(t.c1).click(function () {
        t.c6 = t.c6 - 1;
